...
class Penilaian_ditolak extends CI_Controller {
	...
	public function index()
	{
        ...
        $data["data_nilai"] = $nilai_model->getAllDecline(); //mengambil data untuk ditampilkan pada form
        $this->load->view("admin/penilaian_ditolak/penilaian_ditolak_list.php", $data);
	}
	public function lihat($id = null)
	{
		if (!isset($id)) redirect('admin/penilaian_ditolak'); // redirect jika tidak ada $id 
		$nilai_model = $this->penilaian_model;
		/////////\\\\\\\\\
        $data["nilai_kamu"] = $nilai_model->getPenilaianById($id); //mengambil data untuk ditampilkan pada form
        $this->load->view("admin/penilaian_ditolak/lihat.php", $data);
