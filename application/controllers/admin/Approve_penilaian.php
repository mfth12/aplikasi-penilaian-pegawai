...
class Approve_penilaian extends CI_Controller {
	...
	public function index()
	{
        ...
        $data["data_nilai"] = $nilai_model->getAllApproving(); //mengambil data untuk ditampilkan pada form
        $this->load->view("admin/approve_penilaian/approve_list.php", $data);
	}

	public function lihat($id = null)
	{
		if (!isset($id)) redirect('admin/approve_penilaian'); // redirect jika tidak ada $id 
		$nilai_model = $this->penilaian_model;
		/////////\\\\\\\\\
        $data["nilai_kamu"] = $nilai_model->getPenilaianById($id); //mengambil data untuk ditampilkan pada form
        $this->load->view("admin/approve_penilaian/lihat.php", $data);
