...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        // untuk keamanan data
        // untuk keamanan data
		if ($nilai_kamu->penginput_id != $this->session->userdata('user_id')) show_404(); // tampilkan error jika mengakses penilaian orang lain
        ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid"> 
                        ...
                        <h1 class="mt-4">Lihat Penilaian</h1>
...
<!-- MENAMPILKAN OPSI UNTUK YANG BELUM KONFIRMASI -->
                        <div class="card mb-4">
                            <div class="card-body">
                                Penilaian sudah dikonfirmasi oleh pegawai yang bersangkutan. Silakan untuk menyetujuinya, dan berikan tanggapan anda dari komplain/masukan pegawai tsb.
                                <a href="#">Pelajari lebih lanjut</a>
                            </div> <!-- tutup card -->
                        </div>
    <!-- END OF OPSI UNTUK YANG BELUM KONFIRMASI -->
...
<!-- MENAMPILKAN OPSI UNTUK YANG BELUM KONFIRMASI -->
                        <div class="card mb-4">
                            <div class="card-body">
                            Penilaian ini sudah anda setujui. Sekarang sedang dalam proses meminta keputusan dari yayasan. Bisa diterima, dan juga bisa ditolak penilaian ini.
                                <a href="#">Pelajari lebih lanjut</a>
                            </div> <!-- tutup card -->
                        </div>
    <!-- END OF OPSI UNTUK YANG BELUM KONFIRMASI -->
...
<?php }?> 
          ...
          <div class="card-header">
						...
						<a href="<?php echo site_url('kepsek/hasil_input') ?>"><i class="fas fa-arrow-left"></i>
							Kembali</a>
					</div>
            <div class="card-body">
...
{?>  
<!-- MENAMPILKAN OPSI UNTUK YANG BELUM KONFIRMASI -->
                            <form class="needs-validation" action="<?php echo site_url('kepsek/hasil_input/proses_approve/'.$nilai_kamu->id_penilaian) ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                ...
                                <div class="row">
                                  <div class="form-group col mb-3">
						            ...
						            <textarea rows="5" class="form-control" required name="tanggapan_penilai" placeholder="Berikan tanggapan dari keberatan/komplain pegawai. Jika tidak ada tanggapan, harap diisi 'tidak ada tanggapan'."></textarea>
						            </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="mb-2">
                                <small><a class="text-primary">Catatan: </a>Harap menuliskan tanggapan anda pada kolom tanggapan penilai. Penilaian akan diteruskan, dan menunggu persetujuan dari yayasan.</small>
                                </div>
                                <hr>
...
<!-- MENAMPILKAN OPSI UNTUK YANG BELUM KONFIRMASI -->
                            <form class="needs-validation" action="<?php echo site_url('user/data_penilaian/proses_konfirmasi/'.$nilai_kamu->id_penilaian) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <!-- <hr> -->
                                <!-- <button class="btn btn-secondary" disabled type="reset">Bersihkan</button> -->
                                <button class="btn btn-primary" disabled type="submit">Menunggu keputusan yayasan</button>
                            </form>
    <!-- END OF OPSI UNTUK YANG BELUM KONFIRMASI -->
    <!-- END OF OPSI UNTUK YANG BELUM KONFIRMASI -->
<?php }?> 
