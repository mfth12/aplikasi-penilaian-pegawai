...
<!-- MENAMPILKAN OPSI UNTUK YANG BELUM KONFIRMASI -->
                        <div class="card mb-4">
                            <div class="card-body">
                            Proses penilaian sudah selesai. Sekarang penilaian ini bisa untuk diterima ataupun ditolak.
                                <a href="#">Pelajari lebih lanjut</a>
                            </div> <!-- tutup card -->
                        </div>
    <!-- END OF OPSI UNTUK YANG BELUM KONFIRMASI -->
...
<?php }?> 
          ...
          <div class="card-header">
						...
						<a href="<?php echo site_url('admin/penilaian_ditolak') ?>"><i class="fas fa-arrow-left"></i>
							Kembali</a>
					</div>
            <div class="card-body">
