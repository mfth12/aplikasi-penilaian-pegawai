            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid"> 
                        ...
                        <h1 class="mt-4">Penilaian Ditolak</h1>
                                        ...
                                        <tbody>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    if($data->status == 0) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-secondary"> Pending Konfirmasi </a></span>
                                                        <?php }
                                                    if($data->status == 1) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-secondary"> Terkonfirmasi </a></span>
                                                        <?php } 
                                                    if($data->status == 2) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-secondary"> Ditanggapi Penilai </a></span>
                                                        <?php } 
                                                    if($data->status == 5) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-primary"> Disetujui Yayasan </a></span>
                                                        <?php } 
                                                    if($data->status == 6) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-danger"> Ditolak </a></span>
                                                        <?php } 
                                                    if($data->status == 7) { ?> 
                                                    <a href="<?php echo site_url('admin/penilaian_ditolak/lihat/'.$data->id_penilaian) ?>"><span class="badge badge-primary"> Diarsipkan </a></span>
                                                        <?php } 
